        ...
        r = (function () {
          function e(t) {
            ...
            if (
              ...
              t.classList.add("sidenav-vertical"),
                t.classList.remove("sidenav-horizontal");
            ...
            i(e, [
                  ...
                  if (
                    ...
                    if (this._horizontal && this._isRoot(i))
                      ...
                      if (
                        ...
                        for (
                          var o = i.querySelectorAll(".sidenav-item.open"),
                            r = 0,
                            l = o.length;
                          r < l;
                          r++
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (; s; )
                    s.classList[t ? "add" : "remove"]("active"),
              ...
              },
              {
                key: "setDisabled",
                value: function (e, t) {
                  this._getItem(e, !1).classList[t ? "add" : "remove"](
                    "disabled"
                  );
                },
              },
                ...
                value: function (e, t) {
                  ...
                  if (
                    (e.classList.contains("sidenav-item")
                      ...
                      : e.classList.contains(i) &&
                        (n = e.parentNode.classList.contains("sidenav-item")
                          ? e.parentNode
                          : null),
                    !n)
                  )
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (
                    var s = 0, o = (n = n.slice(0, n.indexOf(i))).length;
                    s < o;
                    s++
                  )
                    if ((n[s].classList.add("open"), this._accordion))
                      for (
                        var r = this._findChild(n[s].parentNode, [
                            "sidenav-item",
                            "open",
                          ]),
                          l = 0,
              ...
              },
              {
                ...
                value: function (e, t) {
                  for (
                    var n = this._findChild(e.parentNode, [
                        "sidenav-item",
                        "open",
                      ]),
                      i = 0,
                    ...
                    : ((t.style.height =
                      ...
                      this._bindAnimationEndEvent(t, function () {
                        if ((t.classList.remove("open"), l(), n))
                          for (
                            var e = t.querySelectorAll(".sidenav-item.open"),
                              r = 0,
                              a = e.length;
                            r < a;
                            r++
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this._evntElClick = function (t) {
                    ...
                    n &&
                      (t.preventDefault(),
                      "true" !== n.getAttribute("data-hover") && e.toggle(n));
                  }),
                    ...
                    this._horizontal &&
                      ...
                      (this._evntHorizontalElClick = function (t) {
                        ...
                        n &&
                          !n.classList.contains("sidenav-toggle") &&
                          e.closeAll();
                      }),
                      ...
                      this._showDropdownOnHover &&
                        ((this._evntInnerMousemove = function (t) {
                          for (
                            var n = e._findParent(t.target, "sidenav-item", !1),
                              i = null;
                            n;
              ...
              },
              {
                ...
                value: function (e) {
                  for (var t = e.childNodes[0], n = null; t && !n; )
                    t.classList &&
                      t.classList.contains("sidenav-menu") &&
                      (n = t),
                      (t = t.nextSibling);
                  if (!n)
                    throw new Error(
              ...
              },
              {
                ...
                value: function (e, t) {
                  for (
                    var n = e.childNodes, i = [], s = 0, o = n.length;
                    s < o;
                    s++
                  )
                    if (n[s].classList) {
