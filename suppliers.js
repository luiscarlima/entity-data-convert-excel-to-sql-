...
$("button").click(() => {
  if (selectedFile) {
    ...
    setTimeout(function () {
      ...
      download(`${sql_MA_CustSuppFor}`, "MA_CustSuppFor.sql", "text/plain");
    }, 2000);
  }
});
